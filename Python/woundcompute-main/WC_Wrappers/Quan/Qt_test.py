...
import wc_functions_reduced as wc_fun
import wellplate_gui as wpg
import wc_data_functions as wc_data
...
#         main_layout.addWidget(QLabel("Please select the appropriate folder:"))
        ...
        dir_layout.addWidget(QLabel("Directory with .nd file:"))
        ...
        self.microscope_type.addItems(["General", "Cytation"])
        ...
        self.max_cpu_usage_percent.setValue(50)  # Default value
    ...
    def organize_files(self,path_input:str,image_type:str='ph1'):
        ...
        wc_fun.create_wc_yaml(path_output, image_type_in=image_type, is_fl_in=False, is_pillars_in=True)
#         print("\tCreated .yaml file")

        basename_list, is_nd = wc_fun.define_basename_list(
        ...
        wc_fun.sort_basename_folders(basename_list, path_input, path_output, self.microscope_type)
        print("\tDone!")
        
        # Extract stage position information from .nd file or from data in folder
        stage_pos_maps = wc_fun.extract_nd_info(
        ...
        wc_fun.efficient_sort_stage_pos(
...
#                     break  # Exit the loop since the folder was successfully created
    ...
    def run_wound_compute(self):
        ...
        for index, basename in enumerate(basename_list):
            ...
            wc_fun.wc_process_folder(os.path.join(path_output, basename), self.max_cpu_usage_percent.value())
    ...
    def extract_metadata(
        ...
        for index, basename in enumerate(basename_list):
            ...
            all_data, metrics, positions = wc_data.extract_data(

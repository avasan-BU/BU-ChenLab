...
# The functions are also used to run the WoundCompute software on the reorganized data.
...
import psutil
import time
from concurrent.futures import ProcessPoolExecutor,ThreadPoolExecutor, wait,FIRST_COMPLETED, ALL_COMPLETED
...
def wc_process_folder(main_folder, cpu_threshold):
